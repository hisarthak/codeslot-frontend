    ...
    ...and many more commnads
        ...
        <aside>
          ...
          <h3>Suggested Repositories</h3>
           ...
           <div className="repo-name-link">
          <p style={{ color: "#74b9ff", display: "flex", fontWeight: "500"}}>
           <span className="the-suggested-repo-user">A</span><span  className='repo-main-info'><span  className='suggested-repo-name'
            onClick={() =>{
              window.scrollTo({
                top: 0,
                behavior: 'instant' // Ensure instant scrolling
            ...
            navigate(`/codeslot/India`)}}
           >Aarti/ChatGPT-clone</span>
           <p className="suggested-repo-desc" >AI chatbot powered by OpenAI's API</p>
